...
pdf(file.path( results_dir, "pdf", "Supp_GTEx_nucleic_acid_batches.pdf"), 
    width = 24, height =16)
marrangeGrob(nuc_plot, nrow=2, ncol=3, top=textGrob(""))
dev.off()

pdf(file.path( results_dir, "pdf", "Supp_GTEx_genotype_batches.pdf"), 
    width = 24, height =16)
marrangeGrob(geno_plot, nrow=2, ncol=3, top=textGrob(""))
dev.off()
